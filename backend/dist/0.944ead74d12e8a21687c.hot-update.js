...
const update_sector_dto_1 = __webpack_require__(80);
const sector_service_1 = __webpack_require__(46);
let SectorController = class SectorController {
    ...
    async update(id, updateSectorDto) {
        return this.usersService.update(id, updateSectorDto);
    }
};
__decorate([
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("ee4307eaa32dda5f821c")
/******/ })();
/******/ 
/******/ }
;