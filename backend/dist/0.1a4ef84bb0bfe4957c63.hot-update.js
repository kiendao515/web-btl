...
let CourseController = class CourseController {
    ...
    async update(id, updateSectorDto) {
        let rs = await this.courseService.update(id, updateSectorDto);
        console.log(rs);
        return {
            data: rs
        };
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, typeof (_c = typeof UpdateDto !== "undefined" && UpdateDto) === "function" ? _c : Object]),
    __metadata("design:returntype", Promise)
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d13390e95c78787e7c64")
/******/ })();
/******/ 
/******/ }
;