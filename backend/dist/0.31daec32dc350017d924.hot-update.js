...
let AddCreditService = class AddCreditService {
    ...
    async acceptRegisterMoreCredit(addCredit) {
        if (addCredit.status == "true" || addCredit.status == "false") {
            let c = await this.addCredit.findOneAndUpdate({ _id: addCredit.addCreditId }, { check: add }, { new: true });
            if (c) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("a50a1654ffcbf4ae78b8")
/******/ })();
/******/ 
/******/ }
;