...
let CourseService = class CourseService {
    ...
    async update(id, updateCourseDto) {
        ...
        if (s) {
            let rs = await this.course.findByIdAndUpdate({ _id: id }, { semeter: updateCourseDto.semester, startDate: update }, { new: true });
            console.log(rs);
            if (rs) {
                return rs;
            }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("0396cac01cf5c5e8caf2")
/******/ })();
/******/ 
/******/ }
;