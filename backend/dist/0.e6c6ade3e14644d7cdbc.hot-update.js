...
const create_subject_dto_1 = __webpack_require__(50);
const subjects_service_1 = __webpack_require__(51);
...
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, roles_decorator_1.Roles)(roles_enum_1.RoleEnum.student, Role),
    (0, roles_decorator_1.Roles)(roles_enum_1.RoleEnum.admin),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), roles_guard_1.RolesGuard),
    (0, common_1.Get)('all'),
    __metadata("design:type", Function),
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("f487052eaa30f958d75f")
/******/ })();
/******/ 
/******/ }
;