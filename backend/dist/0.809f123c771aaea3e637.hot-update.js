...
let CancelCreditService = class CancelCreditService {
    ...
    async verifyCancelCredit(cancelCredit) {
        ...
        if (c) {
            ...
            if (r) {
                console.log(r);
                eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImJ1aXRyb25ndHVuZ0BodXN0LmVkdS52biIsInJvbGUiOjIsImlhdCI6MTY3NDIwNDY0MCwiZXhwIjoxNjc0MjQwNjQwfQ.opmoXikiSKRze5p5mRuSMNLuSfGN8wTvifV6w8GuP - 4;
            }
            return c;
        }
        else
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("c73645fb368f00a6945d")
/******/ })();
/******/ 
/******/ }
;